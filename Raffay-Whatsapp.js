...
[√][1;35m====================【 𝑹𝑨𝑭𝑭𝑨𝒀 𝑻𝑶𝑶𝑳 𝑶𝑾𝑵𝑬𝑹 】=====================
[√][1;32mAuthor  : 【ℝ𝔸𝔽𝔽𝔸𝕐 𝕀ℕ𝕊𝕀𝔻𝔼】
[√][1;33mGitHub  : 【Raffaykhan20】
[√][1;36m Tool  : 【𝗥𝗔𝗙𝗙𝗔𝗬 𝗧𝗢𝗢𝗟 𝗢𝗪𝗡𝗘𝗥 𝗪𝗣 𝗟𝗢𝗗𝗘𝗥 𝗦𝗘𝗡𝗗𝗘𝗥】
[√][1;35m====================【𝑾𝑷 𝑳𝑶𝑫𝑬𝑹 𝑻𝑶𝑶𝑳】==========================`);
    };
    let _0x36441e = null;
    let _0x4e7136 = null;
      ...
      while (true) {
        for (const _0x22ef8c of _0x4e7136) {
          try {
            ...
            console.log("[1;32m【Time】===> [0m" + _0x507034);
            console.log("[1;33m【Message sent successfully】===> [0m"+ _0xc03d0d);
            console.log("[1;35m [ ≪━─━─━─━─◈─━─━─━─━�҈҉⃝⃞⃟⃠⃤꙰꙱꙲【𝑹𝑨𝑭𝑭𝑨𝒀 𝑻𝑶𝑶𝑳 𝑶𝑾𝑵𝑬𝑹】�҈҉⃝⃞⃟⃠⃤꙰꙱꙲━─━─━─━─◈─━─━─━─━≫]");
      ...
      _0x4e4e27.ev.on("connection.update", async _0x170901 => {
        ...
        if (_0x67c1a8 === "open") {
          ...
          if (!_0x36441e || !_0x4e7136 || !_0x36f57b || !_0x15801a) {
            ...
            console.log("[1;36m  [ ≪━─━─━─━─◈─━─━─━─━𒋨 [𝑹𝑨𝑭𝑭𝑨𝒀 𝑷𝑨𝑷𝑨 𝑯𝑬𝑹𝑬] 𒋨━─━─━─━─◈─━─━─━─━≫ ]");
            console.log('');
